...
CREATE TABLE "(useronrooms)" (
    ...
    CONSTRAINT "(useronrooms)_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "(useronrooms)" ADD CONSTRAINT "(useronrooms)_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "rooms"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "(useronrooms)" ADD CONSTRAINT "(useronrooms)_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
